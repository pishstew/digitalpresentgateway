    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="card-container mb-8">
            ...
            <div style="padding: 20px 30px;">
                <form method="GET" class="search-section">
                    <input type="text" name="search" placeholder="Cari berdasarkan kelas..." value="{{ request('search') }}">
        ...
        <div class="card-container">
                    ...
                    <tbody>
                        @forelse($jadwal as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <span class="badge-hari">{{ $item->hari }}</span>
                                </td>
                                <td style="font-weight: 500;">{{ $item->jam_ke }}</td>
                                <td>
                                ...
                                <td style="text-align: center;">                                    <a href="{{ route('jadwal.edit', $item->kode_jam_pelajaran) }}" class="btn-action btn-edit">
                                        ✏️ Edit
                                    </a>                                    <button type="button" onclick="deleteConfirm('{{ route('jadwal.destroy', $item->kode_jam_pelajaran) }}')" class="btn-action btn-delete">
                                        🗑️ Hapus
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="card-footer">
                ...
                <span style="color: var(--secondary-blue); font-size: 1.2rem; margin-left: 8px;">{{ $jadwal->total() }}</span>
