...
<div class="dashboard-bg">
    ...
    <div class="dashboard-grid">
        <!-- Siswa Card -->
        <a href="{{ route('siswa.index') }}" class="dashboard-card siswa" style="text-decoration: none;">
            <div class="card-icon">👥</div>
            <div class="card-title">Siswa</div>
            <div class="card-count">{{ $siswaCount }}</div>
            <div class="stats-text">Total data siswa</div>
            <div class="card-link">Kelola Siswa</div>
        </a>

        <!-- Guru Card -->
        <a href="{{ route('guru.index') }}" class="dashboard-card guru" style="text-decoration: none;">
            <div class="card-icon">👨‍🏫</div>
            <div class="card-title">Guru</div>
            <div class="card-count guru">{{ $guruCount }}</div>
            <div class="stats-text">Total data guru</div>
            <div class="card-link">Kelola Guru</div>
        </a>

        <!-- Mapel Card -->
        <a href="{{ route('mapel.index') }}" class="dashboard-card mapel" style="text-decoration: none;">
            <div class="card-icon">📚</div>
            <div class="card-title">Mata Pelajaran</div>
            <div class="card-count mapel">{{ $mapelCount }}</div>
            <div class="stats-text">Total mata pelajaran</div>
            <div class="card-link">Kelola Mapel</div>
        </a>

        <!-- Jadwal Pelajaran Card -->
        <a href="{{ route('jadwal.index') }}" class="dashboard-card jadwal" style="text-decoration: none;">
            <div class="card-icon">📅</div>
            <div class="card-title">Jadwal Pelajaran</div>
            <div class="card-count jadwal">{{ $jadwalCount }}</div>
            <div class="stats-text">Total jadwal pelajaran</div>
            <div class="card-link">Kelola Jadwal</div>
        </a>

        <!-- Presensi Card -->
        <a href="{{ route('presensi.index') }}" class="dashboard-card presensi" style="text-decoration: none;">
            <div class="card-icon">✅</div>
            <div class="card-title">Presensi</div>
            <div class="card-count presensi">{{ $presensiCount }}</div>
