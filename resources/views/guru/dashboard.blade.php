    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-walikelas {
            ...
            color: white; box-shadow: 0 4px 14px rgba(124,58,237,.28);
        }
        .btn-walikelas:hover { box-shadow: 0 6px 18px rgba(124,58,237,.4); color: white; }
        .btn-kakon {
            background: linear-gradient(135deg, #0891b2, #0e7490);
            color: white; box-shadow: 0 4px 14px rgba(8,145,178,.28);
        }
        ...
        .token-code-big {
            ...
            font-weight: 800;
            color: var(--gold-light);
            letter-spacing: clamp(.6rem, 3vw, 1.2rem);
            line-height: 1;
            position: relative; z-index: 1;
        ...
        .flip-num::after {
            ...
            height: 1px; background: rgba(201,150,60,.2);
        }
        ...
        .progress-track  {
            background: rgba(143,163,192,.15); border-radius: 100px;
        ...
        .expired-overlay {
            ...
            color: #f9a8a8; font-weight: 700; font-size: .95rem;
        }
        ...
        .btn-selesai {
            ...
            color: #f9a8a8;
            border: 1.5px solid rgba(224,92,92,.35);
            border-radius: 10px;
            font-family: 'Plus Jakarta Sans', sans-serif;
            font-size: 1rem; font-weight: 700;
            cursor: pointer; transition: all .25s;
        ...
        @media (max-width: 400px) {
            ...
            .btn-logout-nav .label-text { display: none; }
            .btn-logout-nav { padding: 8px 10px; }
        }
    </style>
</head>
<body>
