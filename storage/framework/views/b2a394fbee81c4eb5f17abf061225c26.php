...
<div class="page-bg py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="card-container mb-8">
            ...
            <div style="padding: 20px 30px;">
                <div style="display: flex; gap: 12px;">
                    <a href="<?php echo e(route('presensi.index', ['kelas' => 'XI SIJA 1'])); ?>" 
                       class="btn-kelas <?php if($kelas === 'XI SIJA 1'): ?> active <?php endif; ?>">
                        👥 XI SIJA 1
                    </a>
                    <a href="<?php echo e(route('presensi.index', ['kelas' => 'XI SIJA 2'])); ?>" 
                       class="btn-kelas <?php if($kelas === 'XI SIJA 2'): ?> active <?php endif; ?>">
                        👥 XI SIJA 2
                    </a>
                </div>
            </div>
        ...
        <div class="card-container mb-8">
            ...
            <div style="padding: 20px 30px;">
                <form method="GET" class="search-section">
                    <input type="text" name="search" placeholder="Cari berdasarkan nama siswa atau status..." value="<?php echo e(request('search')); ?>">
                    <?php if($kelas): ?>
        ...
        <div class="card-container">
            <!-- Card Header -->
            <div class="card-header">
                <h2>📋 Daftar Presensi <?php if($kelas): ?> - <?php echo e($kelas); ?> <?php endif; ?></h2>
            </div>
                ...
                <table class="table-wrapper">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $presensi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($presensi->firstItem() + $index); ?></td>
                                <td style="font-family: monospace; font-weight: 500;"><?php echo e($item->kode_presensi); ?></td>
                                <td style="font-weight: 500;"><?php echo e($item->siswa->nama_siswa ?? '-'); ?></td>
                                <td>
                                    <span class="badge-kelas"><?php echo e($item->jadwal->kelas ?? '-'); ?></span>
                                </td>
                                <td style="font-weight: 500;"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d-m-Y')); ?></td>
                                <td style="font-weight: 500;"><?php echo e($item->jam_masuk ?? '-'); ?></td>
            ...
            <div class="card-footer">
                ...
                <span style="color: var(--secondary-blue); font-size: 1.2rem; margin-left: 8px;"><?php echo e($presensi->total()); ?></span>
                <span style="margin-left: 4px;">record</span>
                <a href="<?php echo e(route('presensi.export')); ?>" class="btn btn-success">
                Export Excel
                </a>
            </div>
        </div>
        ...
        <div style="margin-top: 24px; display: flex; justify-content: center;">
            <?php echo e($presensi->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\presensi\resources\views/admin/presensi/index.blade.php ENDPATH**/ ?>