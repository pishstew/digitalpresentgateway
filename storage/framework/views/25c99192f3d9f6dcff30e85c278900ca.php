...
<div class="page-bg py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="form-section">
            ...
            <form action="<?php echo e(route('guru.store')); ?>" method="POST" class="form-horizontal">
                <?php echo csrf_field(); ?>
        ...
        <div class="card-container mb-8">
            ...
            <div style="padding: 20px 30px;">
                <form method="GET" class="search-section">
                    <input type="text" name="search" placeholder="Cari berdasarkan NIP, nama guru, atau mata pelajaran..." value="<?php echo e(request('search')); ?>">
    ...
    <a href="<?php echo e(route('guru.export')); ?>" class="btn-add">
        ⬇️ Export Excel
    </a>
</div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td style="font-family: monospace; font-weight: 500;"><?php echo e($item->nip); ?></td>
                                <td style="font-weight: 500;"><?php echo e($item->nama_guru); ?></td>
                                <td>
                                    <span class="badge-mapel"><?php echo e($item->mapel->nama_mapel ?? '-'); ?></span>
                                </td>
                                <td style="text-align: center;">
                                    <a href="<?php echo e(route('guru.edit', $item->nip)); ?>" class="btn-action btn-edit">
                                        ✏️ Edit
                                    </a>
                                    <button type="button" onclick="deleteConfirm('<?php echo e(route('guru.destroy', $item->nip)); ?>', '<?php echo e($item->nama_guru); ?>')" class="btn-action btn-delete">
                                        🗑️ Hapus
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="card-footer">
                ...
                <span style="color: var(--secondary-blue); font-size: 1.2rem; margin-left: 8px;"><?php echo e($guru->total()); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\presensi\resources\views/admin/guru/index.blade.php ENDPATH**/ ?>