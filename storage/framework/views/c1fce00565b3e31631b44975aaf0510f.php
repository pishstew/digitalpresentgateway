...
<div class="page-bg py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="form-section">
            ...
            <form action="<?php echo e(route('mapel.store')); ?>" method="POST" class="form-horizontal">
                <?php echo csrf_field(); ?>
        ...
        <div class="card-container mb-8">
            ...
            <div style="padding: 20px 30px;">
                <form method="GET" class="search-section">
                    <input type="text" name="search" placeholder="Cari berdasarkan kode atau nama mata pelajaran..." value="<?php echo e(request('search')); ?>">
        ...
        <div class="card-container">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $mapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td style="font-family: monospace; font-weight: 500;"><?php echo e($item->kode_mapel); ?></td>
                                <td style="font-weight: 500;"><?php echo e($item->nama_mapel); ?></td>
                                <td style="text-align: center;">
                                    <a href="<?php echo e(route('mapel.edit', $item->kode_mapel)); ?>" class="btn-action btn-edit">
                                        ✏️ Edit
                                    </a>
                                    <button type="button" onclick="deleteConfirm('<?php echo e(route('mapel.destroy', $item->kode_mapel)); ?>', '<?php echo e($item->nama_mapel); ?>')" class="btn-action btn-delete">
                                        🗑️ Hapus
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="card-footer">
                ...
                <span style="color: var(--secondary-blue); font-size: 1.2rem; margin-left: 8px;"><?php echo e($mapel->total()); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\presensi\resources\views/admin/mapel/index.blade.php ENDPATH**/ ?>